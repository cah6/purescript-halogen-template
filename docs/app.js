...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Custom.Halogen.Utils"] = $PS["Custom.Halogen.Utils"] || {};
  var exports = $PS["Custom.Halogen.Utils"];
  var Data_Semigroup = $PS["Data.Semigroup"];
...
(function($PS) {
  ...
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Custom_Halogen_Utils = $PS["Custom.Halogen.Utils"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  ...
  var render = function (st) {
      return Halogen_HTML_Elements.div_([ Custom_Halogen_Utils.elClassAttr("button")("button")([ Halogen_HTML_Events.onClick(function (v) {
          return Data_Maybe.Nothing.value;
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Template.component)({
          placeholder: ""
      })(v);
  }));
  exports["main"] = main;
