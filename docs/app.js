...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Custom.HalogenUtils"] = $PS["Custom.HalogenUtils"] || {};
  var exports = $PS["Custom.HalogenUtils"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];                
  var class_ = function (clazz) {
      return Halogen_HTML_Properties.class_(clazz);
  };
  var elClassAttr = function (el) {
      return function (clazz) {
          return function (props) {
              return Halogen_HTML_Elements.element(el)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ class_(clazz) ])(props));
          };
      };
  };
  exports["elClassAttr"] = elClassAttr;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var exports = $PS["Template"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Custom_HalogenUtils = $PS["Custom.HalogenUtils"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  ...
  var handleAction = function (v) {
      ...
      if (v instanceof DoStuff) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
      };
      throw new Error("Failed pattern match at Template (line 53, column 16 - line 57, column 14): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Halogen_VDom_Driver.runUI(Template.component)(Data_Unit.unit)(v);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();