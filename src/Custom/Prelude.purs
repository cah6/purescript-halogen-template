...
import Data.Generic.Rep (class Generic, Argument(..), Constructor(..), NoArguments(..),
    NoConstructors, Product(..), Sum(..))
import Data.Generic.Rep.Show (class GenericShow, class GenericShowArgs, genericShow,
    genericShow', genericShowArgs)
